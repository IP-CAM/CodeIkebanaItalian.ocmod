<?php
class ControllerExtensionModuleCodeIkebanaItalian extends Controller
{
    /**
...
//                       'codeikebana_polish_tax_class_5_id'  => $tax_class_5_id
        ...
        $this->model_setting_setting->editSetting('codeikebana_italian', $toSaveData);
    }
    ...
    public function uninstall()
    {
        // retrive saved id's
        $this->load->model('setting/setting');
        $module_settings = $this->model_setting_setting->getSetting('codeikebana_italian');
        // Language
        $this->load->model('localisation/language');
        $this->model_localisation_language->deleteLanguage($module_settings['codeikebana_italian_language_id']);

        // Currency
//        $this->load->model('localisation/currency');
//        $this->model_localisation_currency->deleteCurrency($module_settings['codeikebana_italian_currency_id']);

        // reveresed order tax class - tax rate - geo zone
        // tax classes
//        $this->load->model('localisation/tax_class');
//        // 23
//        $this->model_localisation_tax_class->deleteTaxClass($module_settings['codeikebana_italian_tax_class_23_id']);
//        // 8
//        $this->model_localisation_tax_class->deleteTaxClass($module_settings['codeikebana_italian_tax_class_8_id']);
//        // 5
//        $this->model_localisation_tax_class->deleteTaxClass($module_settings['codeikebana_italian_tax_class_5_id']);

        // tax rates
//        $this->load->model('localisation/tax_rate');
//        // 23
//        $this->model_localisation_tax_rate->deleteTaxRate($module_settings['codeikebana_italian_tax_rate_23_id']);
//        // 8
//        $this->model_localisation_tax_rate->deleteTaxRate($module_settings['codeikebana_italian_tax_rate_8_id']);
//        // 5
